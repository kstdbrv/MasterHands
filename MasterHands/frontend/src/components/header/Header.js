...
export const Header = () => {
  return (
    ...
    <div className="header__logo">
        ...
        <a href=""><span>Мастер на все руки</span></a>
    </div>
    <div class="hamburger-menu">
      ...
      <ul className="menu__box">
          <li><a className="menu__item" href="">Каталог</a>
                  <input id="li_toggle2" type="checkbox" />
                  <label for="li_toggle2">
                      <span className="span_item"> О сервисе</span></label>
                      <ul className="item_ul">
                          <li className="item_li"><a href="">О нас</a></li>
                          <li className="item_li"><a href="">Документация</a></li>
                          <li className="item_li"><a href="">Контакты</a></li>
                      </ul>
              </li>
              <li>
                  ...
                  <label for="li_toggle3">
                      ...
                      <ul className="item_ul">
                          <li className="item_li"><a href="">Личный кабинет</a></li>
                          <li className="item_li"><a href="">Стать мастером</a></li>
                      </ul>
              </li>
      </ul>
    </div>
    <nav>
        <ul className="header__menu">
          <li className="header_menu-item"><a href="">Каталог</a></li>
          <li className="header_menu-item"><a href="#" class="down">О сервисе</a>
          ...
          <li className="header_menu-item"><a href="#" class="down">Мастеру</a>
            <ul className="submenu">
